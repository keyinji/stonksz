...
const Privacypolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Stonksz.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Stonksz, accessible from{" "}
            <a
              href="https://www.stonksz.com"
              rel="noreferrer"
              target="_blank"
            >
              https://www.stonksz.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: kryptoz.website@gmail.com</li>
      </ul>
    </div>
  );
};
