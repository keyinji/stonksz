...
const Termsofuse = () => {
  return (
    <div>
      ...
      <p>Welcome to stonksz!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Stonksz&apos;s Website, located at https://www.stonksz.com/login.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use stonksz if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing stonksz, you agreed to use
        cookies in agreement with the Stonksz&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Stonksz and/or its licensors own the
        intellectual property rights for all material on stonksz. All
        intellectual property rights are reserved. You may access this from
        stonksz for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from stonksz</li>
        <li>Sell, rent or sub-license material from stonksz</li>
        <li>Reproduce, duplicate or copy material from stonksz</li>
        <li>Redistribute content from stonksz</li>
      </ul>
      ...
      <p>
        ...
        Stonksz does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Stonksz,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Stonksz shall not be liable for the
      ...
      <p>
        Stonksz reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Stonksz a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Stonksz; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Stonksz. Please include your name, your organization name,
      ...
      <p>
        No use of Stonksz&apos;s logo or other artwork will be allowed for linking
